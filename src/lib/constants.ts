...
export const AUTO_REFRESH_MS = 200; // 200ms — high-frequency polling for near-real-time refresh
export const SESSION_LIVENESS_MS = 5_000; // 5 seconds — very short active window for immediate activity
